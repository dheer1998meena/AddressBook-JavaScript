...
try{
    ...
    addressBook.push(new Contact("Dinesh", "Kartik", "EdenGarden", "Kolkatta", "WestBengal", "875 678", "91 2342123456", "dk@gmail.com"));
    addressBook.push(new Contact("Dinesh", "Kartik", "EdenGardens", "Fwrff", "Bengal", "875 678", "91 2342123456", "dk@gmail.com"));
    ...
    for(let i in addressBook)
    {
        ...
        //Here splice method using for remove the ith index 1 element from the addressBook array.
...
console.log("Contact present in the city: "+searchContactInCityOrState("Rajat Sharma","Delhi"));
